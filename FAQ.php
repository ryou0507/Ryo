    ...
    <div class="FAQ-list">
        ...
        <div class="answer-list">
            ...
            <div class="answer-text">
                ...
                各プランに含まれるサービスの詳細や、お客様の理想を実現するための追加オプションについては、<a href="pricing#plan">料金詳細はこちら</a>をご覧ください。
            </div>
        </div>
        <div class="question-list">
            <div class="question-item">Q</div>
        ...
        <div class="answer-list">
            ...
            <div class="answer-text">
                ...
                各プランにおける詳細な対応内容や、さらにカスタマイズしたい場合のオプションについては、<a href="pricing#plan">プラン詳細はこちら</a>をご確認ください。
            </div>
        </div>
        <div class="question-list">
            <div class="question-item">Q</div>
        ...
        <div class="answer-list">
            ...
            <div class="answer-text">はい、ホムクリでは、お客様のホームページを常に最適な状態に保つための包括的な保守・管理サポートを提供しています。<br>
                ...
                保守・管理サービス以外のオプションにも興味がある方は、<a href="pricing#option">対応可能オプションはこちら</a>でご確認ください。
            </div>
        </div>
        <div class="question-list">
            <div class="question-item">Q</div>
        ...
        <div class="answer-list">
            ...
            <div class="answer-text">ホームページ制作時には、h1、h2タグでの見出し構造、メタディスクリプション、画像のalt属性、モバイルフレンドリー設計、キーワード配置を含むSEO基本対策を施します。<br>
                ...
                詳細やその他のオプションに興味のある方は、<a href="pricing#option">対応可能オプションはこちら</a>で確認できます。</div>
        </div>
        <div class="question-list">
            <div class="question-item">Q</div>
        ...
        <div class="answer-list">
            ...
            <div class="answer-text">
                ...
                事業のブランディングを強化し、理想のウェブサイトを目指したい方は、<a href="pricing#option">対応可能オプションはこちら</a>で詳細をご確認ください。
            </div>
        ...
        <div class="answer-list">
            ...
            <div class="answer-text">
                ...
                他に、プランの違いに興味のある方は<a href="pricing#plan">プラン詳細はこちら</a>をご覧ください。
            </div>
        </div>
    </div>
